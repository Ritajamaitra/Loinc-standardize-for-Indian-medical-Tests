    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12 lg-12 sm-12">
          ...
          <h1 class="page-title">Indian Medical Laboratory Tests at Sub-District and District Health Centres</h1>
      ...
      <?php
        ...
        $offset = ($page - 1) * $limit;
        $count=$offset+1;
        $sql= "select * from in1 LIMIT {$offset},{$limit}";
        $result=mysqli_query($conn,$sql);
        
          if(mysqli_num_rows($result)>0)   {
            ?>
             <h3 class="table-title">Table 1: List of diagnostic tests at Sub-District Health Centres </h3>
...
<?php
        ...
        $sql1= "select * from in2 LIMIT {$offset},{$limit}";
